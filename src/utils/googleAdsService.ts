...
export const DEFAULT_ADS_SETTINGS: GoogleAdsSettings = {
  isApproved: true, // Default disetujui untuk demonstrasi, dapat ditutup/diaktifkan oleh Admin
  publisherId: 'ca-pub-3906503668371928',
  approvedBy: 'Admin SGA Redaksi',
  approvedAt: '4 Juli 2026',
  notes: 'Persetujuan resmi penayangan iklan Google AdSense pada portal berita SGA News oleh Pemimpin Redaksi.',
  adPositions: {
    headerBanner: true,
    inArticle: true,
    sidebarUnit: true,
